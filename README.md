Demonstrates how to use [Calendar](https://github.com/wix/react-native-calendars) in a Expo React-Native (CRNA) app with TypeScript, Redux, Redux-Persist, Jest and TSlint.
